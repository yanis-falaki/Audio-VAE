...
class LogSpectrogramExtractor:
    """LogSpectrogramExtractor extracts log spectorgrams (in dB) from a time-series signal"""
...
class MinMaxNormalizer:
    ...
    def normalize(self, array):
        ...
        norm_array = norm_array = norm_array * (self.max - self.min) + self.min
        return norm_array
...
class PreprocessingPipeline:
    """PreprocessingPipeline processes audiofiles in a directory, applying
    ...
    Soring the min max values for all spectrograms"""
...
if __name__ == "__main__":
    ...
    SPECTROGRAMS_SAVE_DIR = "./processed_data/spectrograms/"
    MIN_MAX_VALUES_SAVE_DIR = "./processed_data"
    FILES_DIR = "./data/spoken_mnist_recordings/"
